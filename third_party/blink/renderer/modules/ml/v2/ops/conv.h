...
#ifndef THIRD_PARTY_BLINK_RENDERER_MODULES_ML_OPS_CONV_H_
#define THIRD_PARTY_BLINK_RENDERER_MODULES_ML_OPS_CONV_H_
...
class Conv final : public Output {
 public:
  Conv(Operand*,
       Operand*,
       WTF::Vector<int32_t>,
...
#endif  // THIRD_PARTY_BLINK_RENDERER_MODULES_ML_OPS_CONV_H_
