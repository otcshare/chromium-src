...
"""code generator for webnn command buffers."""
...
# arguments. The named types are used in 'webnn_cmd_buffer_functions.txt'.
#
...
# parsing the "webnn_cmd_buffer_functions.txt", one for each function in the
...
#
# Must match function names specified in "webnn_cmd_buffer_functions.txt".
#
# Options are documented in build_gles2_cmd_buffer.py/build_raster_cmd_buffer.py
...
def main(argv):
  ...
  build_cmd_buffer_lib.InitializePrefix("WebNN")
  gen = build_cmd_buffer_lib.GLGenerator(
      options.verbose, "2022", _FUNCTION_INFO, _NAMED_TYPE_INFO,
      chromium_root_dir)
  gen.ParseGLH("gpu/command_buffer/webnn_cmd_buffer_functions.txt")

  gen.WriteCommandIds("gpu/command_buffer/common/webnn_cmd_ids_autogen.h")
  gen.WriteFormat("gpu/command_buffer/common/webnn_cmd_format_autogen.h")
  gen.WriteFormatTest(
    "gpu/command_buffer/common/webnn_cmd_format_test_autogen.h")
  gen.WriteGLES2InterfaceHeader(
    "gpu/command_buffer/client/webnn_interface_autogen.h")
  gen.WriteGLES2ImplementationHeader(
    "gpu/command_buffer/client/webnn_implementation_autogen.h")
  gen.WriteGLES2InterfaceStub(
    "gpu/command_buffer/client/webnn_interface_stub_autogen.h")
  gen.WriteGLES2InterfaceStubImpl(
      "gpu/command_buffer/client/webnn_interface_stub_impl_autogen.h")
  gen.WriteGLES2Implementation(
    "gpu/command_buffer/client/webnn_implementation_impl_autogen.h")
  gen.WriteGLES2ImplementationUnitTests(
    "gpu/command_buffer/client/webnn_implementation_unittest_autogen.h")
  gen.WriteCmdHelperHeader(
     "gpu/command_buffer/client/webnn_cmd_helper_autogen.h")
  # Note: No gen.WriteServiceImplementation
  # Note: No gen.WriteServiceUnitTests
  gen.WriteServiceUtilsHeader(
    "gpu/command_buffer/service/webnn_cmd_validation_autogen.h")
  gen.WriteServiceUtilsImplementation(
    "gpu/command_buffer/service/"
    "webnn_cmd_validation_implementation_autogen.h")

  build_cmd_buffer_lib.Format(gen.generated_cpp_filenames, output_dir,
                              chromium_root_dir)

  if gen.errors > 0:
    print "build_webnn_cmd_buffer.py: Failed with %d errors" % gen.errors
    return 1
  ...
  if len(check_failed_filenames) > 0:
    print 'Please run gpu/command_buffer/build_webnn_cmd_buffer.py'
